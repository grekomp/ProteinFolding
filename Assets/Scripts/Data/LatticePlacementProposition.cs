...
//			int energy = baseLattice.energy + baseLattice.GetEnergyPoint(x, y, isHydrophobic) + 1;
...
//			if (adjacentCoords.Item1 >= baseLattice.size || adjacentCoords.Item2 >= baseLattice.size) return false;
